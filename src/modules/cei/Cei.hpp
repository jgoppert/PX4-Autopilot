...
private:
	Cei(const Cei &) = delete;
	Cei operator=(const Cei &) = delete;
	...
	DEFINE_PARAMETERS(
		...
		// general parameters
		(ParamInt<px4::params::CEI_FUSION>) _fusion,
		(ParamFloat<px4::params::CEI_VXY_PUB>) _vxy_pub_thresh,
		(ParamFloat<px4::params::CEI_Z_PUB>) _z_pub_thresh,

		// sonar parameters
		(ParamFloat<px4::params::CEI_SNR_Z>) _sonar_z_stddev,
		(ParamFloat<px4::params::CEI_SNR_OFF_Z>) _sonar_z_offset,

		// lidar parameters
		(ParamFloat<px4::params::CEI_LDR_Z>) _lidar_z_stddev,
		(ParamFloat<px4::params::CEI_LDR_OFF_Z>) _lidar_z_offset,

		// accel parameters
		(ParamFloat<px4::params::CEI_ACC_XY>) _accel_xy_stddev,
		(ParamFloat<px4::params::CEI_ACC_Z>) _accel_z_stddev,

		// baro parameters
		(ParamFloat<px4::params::CEI_BAR_Z>) _baro_stddev,

		// gps parameters
		(ParamFloat<px4::params::CEI_GPS_DELAY>) _gps_delay,
		(ParamFloat<px4::params::CEI_GPS_XY>) _gps_xy_stddev,
		(ParamFloat<px4::params::CEI_GPS_Z>) _gps_z_stddev,
		(ParamFloat<px4::params::CEI_GPS_VXY>) _gps_vxy_stddev,
		(ParamFloat<px4::params::CEI_GPS_VZ>) _gps_vz_stddev,
		(ParamFloat<px4::params::CEI_EPH_MAX>) _gps_eph_max,
		(ParamFloat<px4::params::CEI_EPV_MAX>) _gps_epv_max,

		// vision parameters
		(ParamFloat<px4::params::CEI_VIS_XY>) _vision_xy_stddev,
		(ParamFloat<px4::params::CEI_VIS_Z>) _vision_z_stddev,
		(ParamFloat<px4::params::CEI_VIS_DELAY>) _vision_delay,

		// mocap parameters
		(ParamFloat<px4::params::CEI_VIC_P>) _mocap_p_stddev,

		// flow parameters
		(ParamFloat<px4::params::CEI_FLW_OFF_Z>) _flow_z_offset,
		(ParamFloat<px4::params::CEI_FLW_SCALE>) _flow_scale,
		(ParamInt<px4::params::CEI_FLW_QMIN>) _flow_min_q,
		(ParamFloat<px4::params::CEI_FLW_R>) _flow_r,
		(ParamFloat<px4::params::CEI_FLW_RR>) _flow_rr,

		// land parameters
		(ParamFloat<px4::params::CEI_LAND_Z>) _land_z_stddev,
		(ParamFloat<px4::params::CEI_LAND_VXY>) _land_vxy_stddev,

		// process noise
		(ParamFloat<px4::params::CEI_PN_P>) _pn_p_noise_density,
		(ParamFloat<px4::params::CEI_PN_V>) _pn_v_noise_density,
		(ParamFloat<px4::params::CEI_PN_B>) _pn_b_noise_density,
		(ParamFloat<px4::params::CEI_PN_T>) _pn_t_noise_density,
		(ParamFloat<px4::params::CEI_T_MAX_GRADE>) _t_max_grade,

		(ParamFloat<px4::params::CEI_LT_COV>) _target_min_cov,
		(ParamInt<px4::params::LTEST_MODE>) _target_mode,

		// init origin
		(ParamInt<px4::params::CEI_FAKE_ORIGIN>) _fake_origin,
		(ParamFloat<px4::params::CEI_LAT>) _init_origin_lat,
		(ParamFloat<px4::params::CEI_LON>) _init_origin_lon
	)
