...
casadi_functions* ekf_state_derivative_functions(void);
...
casadi_functions* ekf_covariance_derivative_functions(void);
...
casadi_functions* ekf_correct_functions(void);
#ifdef __cplusplus
} /* extern "C" */
#endif
