 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_FLW_OFF_Z, 0.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_FLW_SCALE, 1.3f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_FLW_R, 7.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_FLW_RR, 7.0f);
 ...
 * @decimal 0
 */
PARAM_DEFINE_INT32(CEI_FLW_QMIN, 150);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_SNR_Z, 0.05f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_SNR_OFF_Z, 0.00f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_LDR_Z, 0.03f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_LDR_OFF_Z, 0.00f);
 ...
 * @decimal 4
 */
PARAM_DEFINE_FLOAT(CEI_ACC_XY, 0.012f);
 ...
 * @decimal 4
 */
PARAM_DEFINE_FLOAT(CEI_ACC_Z, 0.02f);
 ...
 * @decimal 2
 */
PARAM_DEFINE_FLOAT(CEI_BAR_Z, 3.0f);
 ...
 * @decimal 2
 */
PARAM_DEFINE_FLOAT(CEI_GPS_DELAY, 0.29f);
 ...
 * @decimal 2
 */
PARAM_DEFINE_FLOAT(CEI_GPS_XY, 1.0f);
 ...
 * @decimal 2
 */
PARAM_DEFINE_FLOAT(CEI_GPS_Z, 3.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_GPS_VXY, 0.25f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_GPS_VZ, 0.25f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_EPH_MAX, 3.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_EPV_MAX, 5.0f);
 ...
 * @decimal 2
 */
PARAM_DEFINE_FLOAT(CEI_VIS_DELAY, 0.1f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_VIS_XY, 0.1f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_VIS_Z, 0.5f);
 ...
 * @decimal 4
 */
PARAM_DEFINE_FLOAT(CEI_VIC_P, 0.001f);
 ...
 * @decimal 8
 */
PARAM_DEFINE_FLOAT(CEI_PN_P, 0.1f);
 ...
 * @decimal 8
 */
PARAM_DEFINE_FLOAT(CEI_PN_V, 0.1f);
 ...
 * @decimal 8
 */
PARAM_DEFINE_FLOAT(CEI_PN_B, 1e-3f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_PN_T, 0.001f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_T_MAX_GRADE, 1.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_FGYRO_HP, 0.001f);

/**
 * Enable publishing of a fake global position (e.g for AUTO missions using Optical Flow)
 * by initializing the estimator to the CEI_LAT/LON parameters when global information is unavailable
 *
 * @group Local Position Estimator
 * @min 0
 * @max 1
 */
PARAM_DEFINE_INT32(CEI_FAKE_ORIGIN, 0);
 ...
 * @decimal 8
 */
PARAM_DEFINE_FLOAT(CEI_LAT, 47.397742f);
 ...
 * @decimal 8
 */
PARAM_DEFINE_FLOAT(CEI_LON, 8.545594);
 ...
 * @decimal 0
 */
PARAM_DEFINE_FLOAT(CEI_X_LP, 5.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_VXY_PUB, 0.3f);
 ...
 * @decimal 1
 */
PARAM_DEFINE_FLOAT(CEI_Z_PUB, 1.0f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_LAND_Z, 0.03f);
 ...
 * @decimal 3
 */
PARAM_DEFINE_FLOAT(CEI_LAND_VXY, 0.05f);
 ...
 * @decimal 2
 */
PARAM_DEFINE_FLOAT(CEI_LT_COV, 0.0001f);
 ...
 * @bit 7  fuse baro
 */
PARAM_DEFINE_INT32(CEI_FUSION, 145);
