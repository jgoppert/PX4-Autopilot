...
BlockLocalPositionEstimatorMulti::BlockLocalPositionEstimatorMulti() :
	...
	// subscriptions
	_sub_status(_nh.subscribe("vehicle_status", 1,
		&BlockLocalPositionEstimatorMulti::handleStatus, this)),
	_sub_armed(_nh.subscribe("actuator_armed", 1,
		&BlockLocalPositionEstimatorMulti::handleArmed, this)),
	_sub_control_mode(_nh.subscribe("control_mode", 1,
		&BlockLocalPositionEstimatorMulti::handleControlMode, this)),
	_sub_att(_nh.subscribe("vehicle_attitude", 1,
		&BlockLocalPositionEstimatorMulti::handleAttitude, this)),
	_sub_att_sp(_nh.subscribe("vehicle_attitude_setpoint", 1,
		&BlockLocalPositionEstimatorMulti::handleAttitudeSetPoint, this)),
	_sub_flow(_nh.subscribe("optical_flow", 1,
		&BlockLocalPositionEstimatorMulti::handleOptcalFlow, this)),
	...
	_sub_param_update(_nh.subscribe("param_update", 1,
		&BlockLocalPositionEstimatorMulti::handleParamUpdate, this)), _sub_manual(_nh.subscribe("manual_control_setpoint", 1,
		&BlockLocalPositionEstimatorMulti::handleManual, this)),
	...
	// publications
	_pub_lpos(_nh.advertise<px4::px4_vehicle_local_position>(
		"vehicle_local_position", 1)),
	_pub_gpos(_nh.advertise<px4::px4_vehicle_global_position>(
		"vehicle_global_position", 1)),
	_pub_filtered_flow(_nh.advertise<px4::px4_filtered_bottom_flow>(
...
void BlockLocalPositionEstimatorMulti::initBaro() {
	// collect baro data
	//if (!_baroInitialized &&
...
void BlockLocalPositionEstimatorMulti::initGps() {
	// collect gps data
...
void BlockLocalPositionEstimatorMulti::initLidar() {
...
void BlockLocalPositionEstimatorMulti::initSonar() {
...
void BlockLocalPositionEstimatorMulti::initFlow() {
...
void BlockLocalPositionEstimatorMulti::initVisionPos() {
...
void BlockLocalPositionEstimatorMulti::initVisionVel() {
...
void BlockLocalPositionEstimatorMulti::initVicon() {
	// collect vicon data
	//if (!_viconInitialized) {
		//// increament sums for mean
		//math::Vector<3> pos;
...
void BlockLocalPositionEstimatorMulti::publishLocalPos(bool z_valid, bool xy_valid) {
	...
	if (isfinite(_x(X_x)) && isfinite(_x(X_y)) && isfinite(_x(X_z)) &&
		...
		&& isfinite(_x(X_vz))) {
		//px4::px4_vehicle_local_position msg;
		...
		//msg.vy = _x(X_vy); // east
		//msg.vz = _x(X_vz); // down
		//msg.yaw = _sub_att.get().yaw;
		//msg.xy_global = _sub_home.get().timestamp != 0; // need home for reference
		//msg.z_global = _baroInitialized;
		//msg.ref_timestamp = _sub_home.get().timestamp;
		//msg.ref_lat = _map_ref.lat_rad*180/M_PI;
		//msg.ref_lon = _map_ref.lon_rad*180/M_PI;
		//msg.ref_alt = _sub_home.get().alt;
		//// TODO, terrain alt
...
void BlockLocalPositionEstimatorMulti::publishGlobalPos(bool dead_reckoning) {
	...
	//if(isfinite(lat) && isfinite(lon) && isfinite(alt) &&
			//isfinite(_x(X_vx)) && isfinite(_x(X_vy)) &&
			//isfinite(_x(X_vz))) {
		//px4::px4_global_position msg;
		//msg.timestamp = _timeStamp;
		//msg.time_utc_usec = _sub_gps.get().time_utc_usec;
		//msg.lat = lat;
		//msg.lon = lon;
		//msg.alt = alt;
		//msg.vel_n = _x(X_vx);
...
void BlockLocalPositionEstimatorMulti::publishFilteredFlow() {
...
void BlockLocalPositionEstimatorMulti::correctFlow() {	
...
void BlockLocalPositionEstimatorMulti::correctSonar() {
...
void BlockLocalPositionEstimatorMulti::correctBaro() {
...
void BlockLocalPositionEstimatorMulti::correctLidar() {
...
void BlockLocalPositionEstimatorMulti::correctGps() {	// TODO : use another other metric for glitch detection
...
void BlockLocalPositionEstimatorMulti::correctVisionPos() {
...
void BlockLocalPositionEstimatorMulti::correctVisionVel() {
...
void BlockLocalPositionEstimatorMulti::correctVicon() {
