...
PARAM_DEFINE_FLOAT(LPE_LDR_Z, 1.0e-1f); // lidar z std dev
PARAM_DEFINE_FLOAT(LPE_ACC_XY, 5.0e-2f); // accel xy std dev
PARAM_DEFINE_FLOAT(LPE_ACC_Z, 5.0e-2f); // accel z std dev
PARAM_DEFINE_FLOAT(LPE_BAR_Z, 1.5f); // baro z std dev
PARAM_DEFINE_FLOAT(LPE_GPS_XY, 1.5f); // gps xy std dev
